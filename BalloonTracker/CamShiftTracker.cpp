...
//	//                                  ---->    ---->     ---->
//    createTrackbar( "H_MIN", trackbarWindowName, &H_FAC, 20, on_trackbar );
//    createTrackbar( "H_MAX", trackbarWindowName, &S_FAC, 20, on_trackbar );
//    createTrackbar( "S_MIN", trackbarWindowName, &THR, 255, on_trackbar );
//
//
//
//}
...
////			if(!found){
////				gpu::split(gpuhsv, hsvplanes);
////				gpu::absdiff(hsvplanes[0], Scalar(90), hsvplanes[0]);
////				gpu::divide(hsvplanes[0], Scalar(H_FAC), hsvplanes[0]);
////				gpu::divide(hsvplanes[1], Scalar(S_FAC), hsvplanes[1]);
////				gpu::multiply(hsvplanes[0], hsvplanes[1], gpuf);
////				gpu::threshold(gpuf, gpuThresh, THR, 255, THRESH_BINARY);
////				gpuf.download(frame);
////				gpuThresh.download(thresh);
...
////						mousev.push_back(center);
////						found = true;
////						trackObject = -1;
////						selection.x = center.x - radius;
////						selection.y = center.y - radius;
